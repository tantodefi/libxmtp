...
impl serde::Serialize for Ping {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("xmtp.xmtpv4.message_api.Ping", len)?;
        if self.nonce != 0 {
            #[allow(clippy::needless_borrow)]
            #[allow(clippy::needless_borrows_for_generic_args)]
...
impl<'de> serde::Deserialize<'de> for Ping {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct xmtp.xmtpv4.message_api.Ping")
            }
        ...
        deserializer.deserialize_struct("xmtp.xmtpv4.message_api.Ping", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for Pong {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("xmtp.xmtpv4.message_api.Pong", len)?;
        if self.nonce != 0 {
            #[allow(clippy::needless_borrow)]
            #[allow(clippy::needless_borrows_for_generic_args)]
            struct_ser.serialize_field("nonce", ToString::to_string(&self.nonce).as_str())?;
...
impl<'de> serde::Deserialize<'de> for Pong {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct xmtp.xmtpv4.message_api.Pong")
            }
        ...
        deserializer.deserialize_struct("xmtp.xmtpv4.message_api.Pong", FIELDS, GeneratedVisitor)
    }
}
...
impl serde::Serialize for SubscribeAllEnvelopesRequest {
    #[allow(deprecated)]
    fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
    where
        S: serde::Serializer,
...
impl<'de> serde::Deserialize<'de> for SubscribeAllEnvelopesRequest {
    #[allow(deprecated)]
    fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
    where
        D: serde::Deserializer<'de>,
    {
        ...
        struct GeneratedVisitor;
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            type Value = SubscribeAllEnvelopesRequest;

            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct xmtp.xmtpv4.message_api.SubscribeAllEnvelopesRequest")
            }

            fn visit_map<V>(self, mut map_: V) -> std::result::Result<SubscribeAllEnvelopesRequest, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
                while map_.next_key::<GeneratedField>()?.is_some() {
        ...
        deserializer.deserialize_struct("xmtp.xmtpv4.message_api.SubscribeAllEnvelopesRequest", FIELDS, GeneratedVisitor)
    }
}
...
impl serde::Serialize for SubscribeOriginatorsRequest {
    #[allow(deprecated)]
    fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
    where
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("xmtp.xmtpv4.message_api.SubscribeOriginatorsRequest", len)?;
...
impl<'de> serde::Deserialize<'de> for SubscribeOriginatorsRequest {
    #[allow(deprecated)]
    fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
    where
        D: serde::Deserializer<'de>,
    {
        ...
        struct GeneratedVisitor;
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            type Value = SubscribeOriginatorsRequest;

            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct xmtp.xmtpv4.message_api.SubscribeOriginatorsRequest")
            }

            fn visit_map<V>(self, mut map_: V) -> std::result::Result<SubscribeOriginatorsRequest, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
                ...
                Ok(SubscribeOriginatorsRequest {
                    filter: filter__,
                })
            }
        }
        deserializer.deserialize_struct("xmtp.xmtpv4.message_api.SubscribeOriginatorsRequest", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for subscribe_originators_request::OriginatorFilter {
    #[allow(deprecated)]
    fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
    where
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("xmtp.xmtpv4.message_api.SubscribeOriginatorsRequest.OriginatorFilter", len)?;
        if !self.originator_node_ids.is_empty() {
            struct_ser.serialize_field("originator_node_ids", &self.originator_node_ids)?;
        }
        if let Some(v) = self.last_seen.as_ref() {
...
impl<'de> serde::Deserialize<'de> for subscribe_originators_request::OriginatorFilter {
    #[allow(deprecated)]
    fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
    where
        D: serde::Deserializer<'de>,
    {
        ...
        struct GeneratedVisitor;
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            type Value = subscribe_originators_request::OriginatorFilter;

            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct xmtp.xmtpv4.message_api.SubscribeOriginatorsRequest.OriginatorFilter")
            }

            fn visit_map<V>(self, mut map_: V) -> std::result::Result<subscribe_originators_request::OriginatorFilter, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
                let mut originator_node_ids__ = None;
                ...
                Ok(subscribe_originators_request::OriginatorFilter {
                    originator_node_ids: originator_node_ids__.unwrap_or_default(),
                    last_seen: last_seen__,
                })
            }
        }
        deserializer.deserialize_struct("xmtp.xmtpv4.message_api.SubscribeOriginatorsRequest.OriginatorFilter", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for SubscribeOriginatorsResponse {
    #[allow(deprecated)]
    fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
    where
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("xmtp.xmtpv4.message_api.SubscribeOriginatorsResponse", len)?;
        if let Some(v) = self.response.as_ref() {
            match v {
                subscribe_originators_response::Response::Envelopes(v) => {
                    struct_ser.serialize_field("envelopes", v)?;
                }
            }
        }
        struct_ser.end()
...
impl<'de> serde::Deserialize<'de> for SubscribeOriginatorsResponse {
    #[allow(deprecated)]
    fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
    where
        D: serde::Deserializer<'de>,
    {
        ...
        struct GeneratedVisitor;
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            type Value = SubscribeOriginatorsResponse;

            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct xmtp.xmtpv4.message_api.SubscribeOriginatorsResponse")
            }

            fn visit_map<V>(self, mut map_: V) -> std::result::Result<SubscribeOriginatorsResponse, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
                ...
                while let Some(k) = map_.next_key()? {
                    match k {
                        GeneratedField::Envelopes => {
                            ...
                            response__ = map_.next_value::<::std::option::Option<_>>()?.map(subscribe_originators_response::Response::Envelopes)
;
                        }
                        GeneratedField::__SkipField__ => {
                            let _ = map_.next_value::<serde::de::IgnoredAny>()?;
                ...
                Ok(SubscribeOriginatorsResponse {
                    response: response__,
                })
            }
        }
        deserializer.deserialize_struct("xmtp.xmtpv4.message_api.SubscribeOriginatorsResponse", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for subscribe_originators_response::Envelopes {
    #[allow(deprecated)]
    fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
    where
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("xmtp.xmtpv4.message_api.SubscribeOriginatorsResponse.Envelopes", len)?;
        if !self.envelopes.is_empty() {
            struct_ser.serialize_field("envelopes", &self.envelopes)?;
        }
        struct_ser.end()
...
impl<'de> serde::Deserialize<'de> for subscribe_originators_response::Envelopes {
    #[allow(deprecated)]
    fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
    where
        D: serde::Deserializer<'de>,
    {
        ...
        struct GeneratedVisitor;
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            type Value = subscribe_originators_response::Envelopes;

            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct xmtp.xmtpv4.message_api.SubscribeOriginatorsResponse.Envelopes")
            }

            fn visit_map<V>(self, mut map_: V) -> std::result::Result<subscribe_originators_response::Envelopes, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
                let mut envelopes__ = None;
                ...
                Ok(subscribe_originators_response::Envelopes {
                    envelopes: envelopes__.unwrap_or_default(),
                })
            }
        }
        deserializer.deserialize_struct("xmtp.xmtpv4.message_api.SubscribeOriginatorsResponse.Envelopes", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for SubscribeRequest {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("xmtp.xmtpv4.message_api.SubscribeRequest", len)?;
        if let Some(v) = self.version.as_ref() {
            match v {
                subscribe_request::Version::V1(v) => {
...
impl<'de> serde::Deserialize<'de> for SubscribeRequest {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct xmtp.xmtpv4.message_api.SubscribeRequest")
            }
                ...
                while let Some(k) = map_.next_key()? {
                    match k {
                        GeneratedField::V1 => {
                            ...
                            version__ = map_.next_value::<::std::option::Option<_>>()?.map(subscribe_request::Version::V1)
;
                        }
                        GeneratedField::__SkipField__ => {
                            let _ = map_.next_value::<serde::de::IgnoredAny>()?;
        ...
        deserializer.deserialize_struct("xmtp.xmtpv4.message_api.SubscribeRequest", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for subscribe_request::V1 {
    #[allow(deprecated)]
    fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
    where
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("xmtp.xmtpv4.message_api.SubscribeRequest.V1", len)?;
        if let Some(v) = self.request.as_ref() {
            match v {
                subscribe_request::v1::Request::Mutate(v) => {
                    struct_ser.serialize_field("mutate", v)?;
                }
                subscribe_request::v1::Request::Ping(v) => {
                    struct_ser.serialize_field("ping", v)?;
                }
                subscribe_request::v1::Request::Pong(v) => {
...
impl<'de> serde::Deserialize<'de> for subscribe_request::V1 {
    #[allow(deprecated)]
    fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
    where
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::Deserialize<'de> for GeneratedField {
                ...
                D: serde::Deserializer<'de>,
            {
                ...
                impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
                    ...
                    {
                        match value {
                            "mutate" => Ok(GeneratedField::Mutate),
        ...
        struct GeneratedVisitor;
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            type Value = subscribe_request::V1;

            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct xmtp.xmtpv4.message_api.SubscribeRequest.V1")
            }

            fn visit_map<V>(self, mut map_: V) -> std::result::Result<subscribe_request::V1, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
                let mut request__ = None;
                while let Some(k) = map_.next_key()? {
                    match k {
                        GeneratedField::Mutate => {
                            if request__.is_some() {
                                return Err(serde::de::Error::duplicate_field("mutate"));
                            }
                            request__ = map_.next_value::<::std::option::Option<_>>()?.map(subscribe_request::v1::Request::Mutate)
;
                        }
                        GeneratedField::Ping => {
                            if request__.is_some() {
                            ...
                            request__ = map_.next_value::<::std::option::Option<_>>()?.map(subscribe_request::v1::Request::Ping)
;
                        }
                        GeneratedField::Pong => {
                            if request__.is_some() {
                            ...
                            request__ = map_.next_value::<::std::option::Option<_>>()?.map(subscribe_request::v1::Request::Pong)
;
                        }
                        GeneratedField::__SkipField__ => {
                            let _ = map_.next_value::<serde::de::IgnoredAny>()?;
                ...
                Ok(subscribe_request::V1 {
                    request: request__,
                })
            }
        }
        deserializer.deserialize_struct("xmtp.xmtpv4.message_api.SubscribeRequest.V1", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for subscribe_request::v1::Mutate {
    #[allow(deprecated)]
    fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
    where
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("xmtp.xmtpv4.message_api.SubscribeRequest.V1.Mutate", len)?;
        if !self.adds.is_empty() {
            struct_ser.serialize_field("adds", &self.adds)?;
        }
        if !self.removes.is_empty() {
            struct_ser.serialize_field("removes", &self.removes.iter().map(pbjson::private::base64::encode).collect::<Vec<_>>())?;
        }
        if self.history_only {
            struct_ser.serialize_field("history_only", &self.history_only)?;
        }
        if self.mutate_id != 0 {
            #[allow(clippy::needless_borrow)]
            #[allow(clippy::needless_borrows_for_generic_args)]
...
impl<'de> serde::Deserialize<'de> for subscribe_request::v1::Mutate {
    #[allow(deprecated)]
    fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
    where
        D: serde::Deserializer<'de>,
    {
                ...
                impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
                        ...
                        E: serde::de::Error,
                    {
                        match value {
                            ...
                            "removes" => Ok(GeneratedField::Removes),
                            "historyOnly" | "history_only" => Ok(GeneratedField::HistoryOnly),
        ...
        struct GeneratedVisitor;
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            type Value = subscribe_request::v1::Mutate;

            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct xmtp.xmtpv4.message_api.SubscribeRequest.V1.Mutate")
            }

            fn visit_map<V>(self, mut map_: V) -> std::result::Result<subscribe_request::v1::Mutate, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
                let mut adds__ = None;
                let mut removes__ = None;
                let mut history_only__ = None;
                ...
                while let Some(k) = map_.next_key()? {
                    match k {
                        GeneratedField::Adds => {
                            ...
                            adds__ = Some(map_.next_value()?);
                        }
                        GeneratedField::Removes => {
                            if removes__.is_some() {
                                return Err(serde::de::Error::duplicate_field("removes"));
                            }
                            removes__ = 
                                Some(map_.next_value::<Vec<::pbjson::private::BytesDeserialize<_>>>()?
                                    .into_iter().map(|x| x.0).collect())
                        ...
                        GeneratedField::HistoryOnly => {
                            if history_only__.is_some() {
                                return Err(serde::de::Error::duplicate_field("historyOnly"));
                            }
                            history_only__ = Some(map_.next_value()?);
                        }
                ...
                Ok(subscribe_request::v1::Mutate {
                    adds: adds__.unwrap_or_default(),
                    removes: removes__.unwrap_or_default(),
                    history_only: history_only__.unwrap_or_default(),
                    mutate_id: mutate_id__.unwrap_or_default(),
                })
            }
        }
        deserializer.deserialize_struct("xmtp.xmtpv4.message_api.SubscribeRequest.V1.Mutate", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for subscribe_request::v1::mutate::Subscription {
    #[allow(deprecated)]
    fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
    where
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("xmtp.xmtpv4.message_api.SubscribeRequest.V1.Mutate.Subscription", len)?;
        if !self.topic.is_empty() {
            #[allow(clippy::needless_borrow)]
            #[allow(clippy::needless_borrows_for_generic_args)]
            struct_ser.serialize_field("topic", pbjson::private::base64::encode(&self.topic).as_str())?;
        }
        if let Some(v) = self.last_seen.as_ref() {
            struct_ser.serialize_field("last_seen", v)?;
        }
...
impl<'de> serde::Deserialize<'de> for subscribe_request::v1::mutate::Subscription {
    #[allow(deprecated)]
    fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
    where
        D: serde::Deserializer<'de>,
    {
        ...
        struct GeneratedVisitor;
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            type Value = subscribe_request::v1::mutate::Subscription;

            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct xmtp.xmtpv4.message_api.SubscribeRequest.V1.Mutate.Subscription")
            }

            fn visit_map<V>(self, mut map_: V) -> std::result::Result<subscribe_request::v1::mutate::Subscription, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
                ...
                Ok(subscribe_request::v1::mutate::Subscription {
                    topic: topic__.unwrap_or_default(),
                    last_seen: last_seen__,
                })
            }
        }
        deserializer.deserialize_struct("xmtp.xmtpv4.message_api.SubscribeRequest.V1.Mutate.Subscription", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for SubscribeResponse {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("xmtp.xmtpv4.message_api.SubscribeResponse", len)?;
        if let Some(v) = self.version.as_ref() {
            match v {
                subscribe_response::Version::V1(v) => {
                    struct_ser.serialize_field("v1", v)?;
                }
            }
        }
...
impl<'de> serde::Deserialize<'de> for SubscribeResponse {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct xmtp.xmtpv4.message_api.SubscribeResponse")
            }
                ...
                while let Some(k) = map_.next_key()? {
                    match k {
                        GeneratedField::V1 => {
                            ...
                            version__ = map_.next_value::<::std::option::Option<_>>()?.map(subscribe_response::Version::V1)
;
                        }
                        GeneratedField::__SkipField__ => {
                            let _ = map_.next_value::<serde::de::IgnoredAny>()?;
        ...
        deserializer.deserialize_struct("xmtp.xmtpv4.message_api.SubscribeResponse", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for subscribe_response::V1 {
    #[allow(deprecated)]
    fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
    where
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("xmtp.xmtpv4.message_api.SubscribeResponse.V1", len)?;
        if let Some(v) = self.response.as_ref() {
            match v {
                subscribe_response::v1::Response::Envelopes(v) => {
                    struct_ser.serialize_field("envelopes", v)?;
                }
                subscribe_response::v1::Response::Started(v) => {
                    struct_ser.serialize_field("started", v)?;
                }
                subscribe_response::v1::Response::Ping(v) => {
                    struct_ser.serialize_field("ping", v)?;
                }
                subscribe_response::v1::Response::Pong(v) => {
                    struct_ser.serialize_field("pong", v)?;
                }
                subscribe_response::v1::Response::TopicsLive(v) => {
                    struct_ser.serialize_field("topics_live", v)?;
                }
                subscribe_response::v1::Response::CatchupComplete(v) => {
                    struct_ser.serialize_field("catchup_complete", v)?;
                }
            }
        }
        struct_ser.end()
...
impl<'de> serde::Deserialize<'de> for subscribe_response::V1 {
    #[allow(deprecated)]
    fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
    where
        D: serde::Deserializer<'de>,
    {
                ...
                impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
                        ...
                        E: serde::de::Error,
                    {
                        match value {
                            ...
                            "ping" => Ok(GeneratedField::Ping),
                            "pong" => Ok(GeneratedField::Pong),
                            "topicsLive" | "topics_live" => Ok(GeneratedField::TopicsLive),
                            "catchupComplete" | "catchup_complete" => Ok(GeneratedField::CatchupComplete),
                            _ => Ok(GeneratedField::__SkipField__),
                        }
                    }
                }
        ...
        struct GeneratedVisitor;
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            type Value = subscribe_response::V1;

            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct xmtp.xmtpv4.message_api.SubscribeResponse.V1")
            }

            fn visit_map<V>(self, mut map_: V) -> std::result::Result<subscribe_response::V1, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
                let mut response__ = None;
                while let Some(k) = map_.next_key()? {
                    match k {
                        GeneratedField::Envelopes => {
                            ...
                            response__ = map_.next_value::<::std::option::Option<_>>()?.map(subscribe_response::v1::Response::Envelopes)
;
                        }
                        GeneratedField::Started => {
                            ...
                            response__ = map_.next_value::<::std::option::Option<_>>()?.map(subscribe_response::v1::Response::Started)
;
                        }
                        GeneratedField::Ping => {
                            if response__.is_some() {
                            ...
                            response__ = map_.next_value::<::std::option::Option<_>>()?.map(subscribe_response::v1::Response::Ping)
;
                        }
                        GeneratedField::Pong => {
                            if response__.is_some() {
                            ...
                            response__ = map_.next_value::<::std::option::Option<_>>()?.map(subscribe_response::v1::Response::Pong)
;
                        }
                        GeneratedField::TopicsLive => {
                            if response__.is_some() {
                                return Err(serde::de::Error::duplicate_field("topicsLive"));
                            }
                            response__ = map_.next_value::<::std::option::Option<_>>()?.map(subscribe_response::v1::Response::TopicsLive)
;
                        }
                        GeneratedField::CatchupComplete => {
                            if response__.is_some() {
                                return Err(serde::de::Error::duplicate_field("catchupComplete"));
                            }
                            response__ = map_.next_value::<::std::option::Option<_>>()?.map(subscribe_response::v1::Response::CatchupComplete)
;
                        }
                        GeneratedField::__SkipField__ => {
                            let _ = map_.next_value::<serde::de::IgnoredAny>()?;
                ...
                Ok(subscribe_response::V1 {
                    response: response__,
                })
            }
        }
        deserializer.deserialize_struct("xmtp.xmtpv4.message_api.SubscribeResponse.V1", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for subscribe_response::v1::Capability {
    #[allow(deprecated)]
    fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
    where
        S: serde::Serializer,
...
impl<'de> serde::Deserialize<'de> for subscribe_response::v1::Capability {
    #[allow(deprecated)]
    fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
    where
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            type Value = subscribe_response::v1::Capability;
            ...
            {
                match value {
                    "CAPABILITY_UNSPECIFIED" => Ok(subscribe_response::v1::Capability::Unspecified),
                    _ => Err(serde::de::Error::unknown_variant(value, FIELDS)),
                }
            }
        }
...
impl serde::Serialize for subscribe_response::v1::CatchupComplete {
    #[allow(deprecated)]
    fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
    where
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("xmtp.xmtpv4.message_api.SubscribeResponse.V1.CatchupComplete", len)?;
        if self.mutate_id != 0 {
            #[allow(clippy::needless_borrow)]
            #[allow(clippy::needless_borrows_for_generic_args)]
            struct_ser.serialize_field("mutate_id", ToString::to_string(&self.mutate_id).as_str())?;
...
impl<'de> serde::Deserialize<'de> for subscribe_response::v1::CatchupComplete {
    #[allow(deprecated)]
    fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
    where
        D: serde::Deserializer<'de>,
    {
        ...
        struct GeneratedVisitor;
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            type Value = subscribe_response::v1::CatchupComplete;

            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct xmtp.xmtpv4.message_api.SubscribeResponse.V1.CatchupComplete")
            }

            fn visit_map<V>(self, mut map_: V) -> std::result::Result<subscribe_response::v1::CatchupComplete, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
                let mut mutate_id__ = None;
                ...
                Ok(subscribe_response::v1::CatchupComplete {
                    mutate_id: mutate_id__.unwrap_or_default(),
                })
            }
        }
        deserializer.deserialize_struct("xmtp.xmtpv4.message_api.SubscribeResponse.V1.CatchupComplete", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for subscribe_response::v1::Envelopes {
    #[allow(deprecated)]
    fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
    where
        S: serde::Serializer,
...
impl<'de> serde::Deserialize<'de> for subscribe_response::v1::Envelopes {
    #[allow(deprecated)]
    fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
    where
        D: serde::Deserializer<'de>,
    {
        ...
        struct GeneratedVisitor;
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            type Value = subscribe_response::v1::Envelopes;

            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct xmtp.xmtpv4.message_api.SubscribeResponse.V1.Envelopes")
            }

            fn visit_map<V>(self, mut map_: V) -> std::result::Result<subscribe_response::v1::Envelopes, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
                let mut envelopes__ = None;
        ...
        deserializer.deserialize_struct("xmtp.xmtpv4.message_api.SubscribeResponse.V1.Envelopes", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for subscribe_response::v1::Started {
    #[allow(deprecated)]
    fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
    where
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("xmtp.xmtpv4.message_api.SubscribeResponse.V1.Started", len)?;
        if self.keepalive_interval_ms != 0 {
            struct_ser.serialize_field("keepalive_interval_ms", &self.keepalive_interval_ms)?;
        }
        if !self.capabilities.is_empty() {
            let v = self.capabilities.iter().cloned().map(|v| {
                subscribe_response::v1::Capability::try_from(v)
...
impl<'de> serde::Deserialize<'de> for subscribe_response::v1::Started {
    #[allow(deprecated)]
    fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
    where
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::Deserialize<'de> for GeneratedField {
                ...
                D: serde::Deserializer<'de>,
            {
                ...
                impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
                    ...
                    {
                        match value {
                            "keepaliveIntervalMs" | "keepalive_interval_ms" => Ok(GeneratedField::KeepaliveIntervalMs),
        ...
        struct GeneratedVisitor;
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            type Value = subscribe_response::v1::Started;

            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct xmtp.xmtpv4.message_api.SubscribeResponse.V1.Started")
            }

            fn visit_map<V>(self, mut map_: V) -> std::result::Result<subscribe_response::v1::Started, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
                let mut keepalive_interval_ms__ = None;
                let mut capabilities__ = None;
                while let Some(k) = map_.next_key()? {
                    match k {
                        GeneratedField::KeepaliveIntervalMs => {
                            if keepalive_interval_ms__.is_some() {
                                return Err(serde::de::Error::duplicate_field("keepaliveIntervalMs"));
                            }
                            keepalive_interval_ms__ = 
                                Some(map_.next_value::<::pbjson::private::NumberDeserialize<_>>()?.0)
                            ;
                        }
                        GeneratedField::Capabilities => {
                            ...
                            capabilities__ = Some(map_.next_value::<Vec<subscribe_response::v1::Capability>>()?.into_iter().map(|x| x as i32).collect());
                        }
                        GeneratedField::__SkipField__ => {
                            let _ = map_.next_value::<serde::de::IgnoredAny>()?;
                        }
                ...
                Ok(subscribe_response::v1::Started {
                    keepalive_interval_ms: keepalive_interval_ms__.unwrap_or_default(),
                    capabilities: capabilities__.unwrap_or_default(),
                })
            }
        }
        deserializer.deserialize_struct("xmtp.xmtpv4.message_api.SubscribeResponse.V1.Started", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for subscribe_response::v1::TopicsLive {
    #[allow(deprecated)]
    fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
    where
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("xmtp.xmtpv4.message_api.SubscribeResponse.V1.TopicsLive", len)?;
        if !self.topics.is_empty() {
            struct_ser.serialize_field("topics", &self.topics.iter().map(pbjson::private::base64::encode).collect::<Vec<_>>())?;
        }
        struct_ser.end()
...
impl<'de> serde::Deserialize<'de> for subscribe_response::v1::TopicsLive {
    #[allow(deprecated)]
    fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
    where
        D: serde::Deserializer<'de>,
    {
        ...
        struct GeneratedVisitor;
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            type Value = subscribe_response::v1::TopicsLive;

            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct xmtp.xmtpv4.message_api.SubscribeResponse.V1.TopicsLive")
            }

            fn visit_map<V>(self, mut map_: V) -> std::result::Result<subscribe_response::v1::TopicsLive, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
                let mut topics__ = None;
                ...
                Ok(subscribe_response::v1::TopicsLive {
                    topics: topics__.unwrap_or_default(),
                })
            }
        }
        deserializer.deserialize_struct("xmtp.xmtpv4.message_api.SubscribeResponse.V1.TopicsLive", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for SubscribeTopicsRequest {
    #[allow(deprecated)]
    fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
    where
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("xmtp.xmtpv4.message_api.SubscribeTopicsRequest", len)?;
        if !self.filters.is_empty() {
...
impl<'de> serde::Deserialize<'de> for SubscribeTopicsRequest {
    #[allow(deprecated)]
    fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
    where
        D: serde::Deserializer<'de>,
    {
        ...
        struct GeneratedVisitor;
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            type Value = SubscribeTopicsRequest;

            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct xmtp.xmtpv4.message_api.SubscribeTopicsRequest")
            }

            fn visit_map<V>(self, mut map_: V) -> std::result::Result<SubscribeTopicsRequest, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
                ...
                Ok(SubscribeTopicsRequest {
                    filters: filters__.unwrap_or_default(),
                })
            }
        }
        deserializer.deserialize_struct("xmtp.xmtpv4.message_api.SubscribeTopicsRequest", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for subscribe_topics_request::TopicFilter {
    #[allow(deprecated)]
    fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
    where
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("xmtp.xmtpv4.message_api.SubscribeTopicsRequest.TopicFilter", len)?;
        if !self.topic.is_empty() {
            #[allow(clippy::needless_borrow)]
            #[allow(clippy::needless_borrows_for_generic_args)]
            struct_ser.serialize_field("topic", pbjson::private::base64::encode(&self.topic).as_str())?;
...
impl<'de> serde::Deserialize<'de> for subscribe_topics_request::TopicFilter {
    #[allow(deprecated)]
    fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
    where
        D: serde::Deserializer<'de>,
    {
        ...
        struct GeneratedVisitor;
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            type Value = subscribe_topics_request::TopicFilter;

            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct xmtp.xmtpv4.message_api.SubscribeTopicsRequest.TopicFilter")
            }

            fn visit_map<V>(self, mut map_: V) -> std::result::Result<subscribe_topics_request::TopicFilter, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
                let mut topic__ = None;
                ...
                Ok(subscribe_topics_request::TopicFilter {
                    topic: topic__.unwrap_or_default(),
                    last_seen: last_seen__,
                })
            }
        }
        deserializer.deserialize_struct("xmtp.xmtpv4.message_api.SubscribeTopicsRequest.TopicFilter", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for SubscribeTopicsResponse {
    #[allow(deprecated)]
    fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
    where
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("xmtp.xmtpv4.message_api.SubscribeTopicsResponse", len)?;
        if let Some(v) = self.response.as_ref() {
            match v {
                subscribe_topics_response::Response::Envelopes(v) => {
                    struct_ser.serialize_field("envelopes", v)?;
                }
                subscribe_topics_response::Response::StatusUpdate(v) => {
                    struct_ser.serialize_field("status_update", v)?;
                }
            }
        }
        struct_ser.end()
...
impl<'de> serde::Deserialize<'de> for SubscribeTopicsResponse {
    #[allow(deprecated)]
    fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
    where
        D: serde::Deserializer<'de>,
    {
        ...
        struct GeneratedVisitor;
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            type Value = SubscribeTopicsResponse;

            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct xmtp.xmtpv4.message_api.SubscribeTopicsResponse")
            }

            fn visit_map<V>(self, mut map_: V) -> std::result::Result<SubscribeTopicsResponse, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
                let mut response__ = None;
                while let Some(k) = map_.next_key()? {
                    match k {
                        GeneratedField::Envelopes => {
                            ...
                            response__ = map_.next_value::<::std::option::Option<_>>()?.map(subscribe_topics_response::Response::Envelopes)
;
                        }
                        GeneratedField::StatusUpdate => {
                            ...
                            response__ = map_.next_value::<::std::option::Option<_>>()?.map(subscribe_topics_response::Response::StatusUpdate)
;
                        }
                        GeneratedField::__SkipField__ => {
                            let _ = map_.next_value::<serde::de::IgnoredAny>()?;
                ...
                Ok(SubscribeTopicsResponse {
                    response: response__,
                })
            }
        }
        deserializer.deserialize_struct("xmtp.xmtpv4.message_api.SubscribeTopicsResponse", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for subscribe_topics_response::Envelopes {
    #[allow(deprecated)]
    fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
    where
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("xmtp.xmtpv4.message_api.SubscribeTopicsResponse.Envelopes", len)?;
        if !self.envelopes.is_empty() {
            struct_ser.serialize_field("envelopes", &self.envelopes)?;
        }
        struct_ser.end()
...
impl<'de> serde::Deserialize<'de> for subscribe_topics_response::Envelopes {
    #[allow(deprecated)]
    fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
    where
        D: serde::Deserializer<'de>,
    {
        ...
        struct GeneratedVisitor;
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            type Value = subscribe_topics_response::Envelopes;

            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct xmtp.xmtpv4.message_api.SubscribeTopicsResponse.Envelopes")
            }

            fn visit_map<V>(self, mut map_: V) -> std::result::Result<subscribe_topics_response::Envelopes, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
                let mut envelopes__ = None;
                ...
                Ok(subscribe_topics_response::Envelopes {
                    envelopes: envelopes__.unwrap_or_default(),
                })
            }
        }
        deserializer.deserialize_struct("xmtp.xmtpv4.message_api.SubscribeTopicsResponse.Envelopes", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for subscribe_topics_response::StatusUpdate {
    #[allow(deprecated)]
    fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
    where
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("xmtp.xmtpv4.message_api.SubscribeTopicsResponse.StatusUpdate", len)?;
        if self.status != 0 {
            let v = subscribe_topics_response::SubscriptionStatus::try_from(self.status)
...
impl<'de> serde::Deserialize<'de> for subscribe_topics_response::StatusUpdate {
    #[allow(deprecated)]
    fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
    where
        D: serde::Deserializer<'de>,
    {
        ...
        struct GeneratedVisitor;
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            type Value = subscribe_topics_response::StatusUpdate;

            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct xmtp.xmtpv4.message_api.SubscribeTopicsResponse.StatusUpdate")
            }

            fn visit_map<V>(self, mut map_: V) -> std::result::Result<subscribe_topics_response::StatusUpdate, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
                ...
                while let Some(k) = map_.next_key()? {
                    match k {
                        GeneratedField::Status => {
                            ...
                            status__ = Some(map_.next_value::<subscribe_topics_response::SubscriptionStatus>()? as i32);
                        }
                        GeneratedField::__SkipField__ => {
                            let _ = map_.next_value::<serde::de::IgnoredAny>()?;
                        }
                ...
                Ok(subscribe_topics_response::StatusUpdate {
                    status: status__.unwrap_or_default(),
                })
            }
        }
        deserializer.deserialize_struct("xmtp.xmtpv4.message_api.SubscribeTopicsResponse.StatusUpdate", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for subscribe_topics_response::SubscriptionStatus {
    #[allow(deprecated)]
    fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
    where
        S: serde::Serializer,
...
impl<'de> serde::Deserialize<'de> for subscribe_topics_response::SubscriptionStatus {
    #[allow(deprecated)]
    fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
    where
        D: serde::Deserializer<'de>,
    {
        const FIELDS: &[&str] = &[
            ...
            "SUBSCRIPTION_STATUS_STARTED",
            "SUBSCRIPTION_STATUS_CATCHUP_COMPLETE",
            "SUBSCRIPTION_STATUS_WAITING",
        ];
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            {
                match value {
                    "SUBSCRIPTION_STATUS_UNSPECIFIED" => Ok(subscribe_topics_response::SubscriptionStatus::Unspecified),
                    "SUBSCRIPTION_STATUS_STARTED" => Ok(subscribe_topics_response::SubscriptionStatus::Started),
                    "SUBSCRIPTION_STATUS_CATCHUP_COMPLETE" => Ok(subscribe_topics_response::SubscriptionStatus::CatchupComplete),
                    "SUBSCRIPTION_STATUS_WAITING" => Ok(subscribe_topics_response::SubscriptionStatus::Waiting),
                    _ => Err(serde::de::Error::unknown_variant(value, FIELDS)),
                }
            }
        }
