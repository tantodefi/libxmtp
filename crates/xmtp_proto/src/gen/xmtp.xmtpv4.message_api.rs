...
pub mod subscribe_request {
    ...
    pub mod v1 {
        ...
        pub mod mutate {
            ...
            pub struct Subscription {
                ...
                pub last_seen: ::core::option::Option<
                    super::super::super::super::envelopes::Cursor,
                >,
            }
            impl ::prost::Name for Subscription {
                ...
                const PACKAGE: &'static str = "xmtp.xmtpv4.message_api";
                fn full_name() -> ::prost::alloc::string::String {
                    "xmtp.xmtpv4.message_api.SubscribeRequest.V1.Mutate.Subscription"
                        .into()
                }
                fn type_url() -> ::prost::alloc::string::String {
                    "/xmtp.xmtpv4.message_api.SubscribeRequest.V1.Mutate.Subscription"
        ...
        impl ::prost::Name for Mutate {
            ...
            const PACKAGE: &'static str = "xmtp.xmtpv4.message_api";
            fn full_name() -> ::prost::alloc::string::String {
                "xmtp.xmtpv4.message_api.SubscribeRequest.V1.Mutate".into()
            }
            fn type_url() -> ::prost::alloc::string::String {
                "/xmtp.xmtpv4.message_api.SubscribeRequest.V1.Mutate".into()
            }
    ...
    impl ::prost::Name for V1 {
        ...
        const PACKAGE: &'static str = "xmtp.xmtpv4.message_api";
        fn full_name() -> ::prost::alloc::string::String {
            "xmtp.xmtpv4.message_api.SubscribeRequest.V1".into()
        }
        fn type_url() -> ::prost::alloc::string::String {
            "/xmtp.xmtpv4.message_api.SubscribeRequest.V1".into()
        }
...
impl ::prost::Name for SubscribeRequest {
    ...
    const PACKAGE: &'static str = "xmtp.xmtpv4.message_api";
    fn full_name() -> ::prost::alloc::string::String {
        "xmtp.xmtpv4.message_api.SubscribeRequest".into()
    }
    fn type_url() -> ::prost::alloc::string::String {
        "/xmtp.xmtpv4.message_api.SubscribeRequest".into()
    }
...
pub mod subscribe_response {
    ...
    pub mod v1 {
        ...
        impl ::prost::Name for Envelopes {
            ...
            const PACKAGE: &'static str = "xmtp.xmtpv4.message_api";
            fn full_name() -> ::prost::alloc::string::String {
                "xmtp.xmtpv4.message_api.SubscribeResponse.V1.Envelopes".into()
            }
            fn type_url() -> ::prost::alloc::string::String {
                "/xmtp.xmtpv4.message_api.SubscribeResponse.V1.Envelopes".into()
            }
        ...
        impl ::prost::Name for CatchupComplete {
            ...
            const PACKAGE: &'static str = "xmtp.xmtpv4.message_api";
            fn full_name() -> ::prost::alloc::string::String {
                "xmtp.xmtpv4.message_api.SubscribeResponse.V1.CatchupComplete".into()
            }
            fn type_url() -> ::prost::alloc::string::String {
                "/xmtp.xmtpv4.message_api.SubscribeResponse.V1.CatchupComplete".into()
            }
        ...
        impl ::prost::Name for TopicsLive {
            ...
            const PACKAGE: &'static str = "xmtp.xmtpv4.message_api";
            fn full_name() -> ::prost::alloc::string::String {
                "xmtp.xmtpv4.message_api.SubscribeResponse.V1.TopicsLive".into()
            }
            fn type_url() -> ::prost::alloc::string::String {
                "/xmtp.xmtpv4.message_api.SubscribeResponse.V1.TopicsLive".into()
            }
    ...
    impl ::prost::Name for V1 {
        ...
        const PACKAGE: &'static str = "xmtp.xmtpv4.message_api";
        fn full_name() -> ::prost::alloc::string::String {
            "xmtp.xmtpv4.message_api.SubscribeResponse.V1".into()
        }
        fn type_url() -> ::prost::alloc::string::String {
            "/xmtp.xmtpv4.message_api.SubscribeResponse.V1".into()
        }
...
impl ::prost::Name for SubscribeResponse {
    ...
    const PACKAGE: &'static str = "xmtp.xmtpv4.message_api";
    fn full_name() -> ::prost::alloc::string::String {
        "xmtp.xmtpv4.message_api.SubscribeResponse".into()
    }
    fn type_url() -> ::prost::alloc::string::String {
        "/xmtp.xmtpv4.message_api.SubscribeResponse".into()
    }
...
impl ::prost::Name for Ping {
    ...
    const PACKAGE: &'static str = "xmtp.xmtpv4.message_api";
    fn full_name() -> ::prost::alloc::string::String {
        "xmtp.xmtpv4.message_api.Ping".into()
    }
    fn type_url() -> ::prost::alloc::string::String {
        "/xmtp.xmtpv4.message_api.Ping".into()
    }
...
impl ::prost::Name for Pong {
    ...
    const PACKAGE: &'static str = "xmtp.xmtpv4.message_api";
    fn full_name() -> ::prost::alloc::string::String {
        "xmtp.xmtpv4.message_api.Pong".into()
    }
    fn type_url() -> ::prost::alloc::string::String {
        "/xmtp.xmtpv4.message_api.Pong".into()
    }
...
impl ::prost::Name for SubscribeAllEnvelopesRequest {
    ...
    const PACKAGE: &'static str = "xmtp.xmtpv4.message_api";
    fn full_name() -> ::prost::alloc::string::String {
        "xmtp.xmtpv4.message_api.SubscribeAllEnvelopesRequest".into()
    }
    fn type_url() -> ::prost::alloc::string::String {
        "/xmtp.xmtpv4.message_api.SubscribeAllEnvelopesRequest".into()
    }
...
pub mod subscribe_originators_request {
    ...
    impl ::prost::Name for OriginatorFilter {
        ...
        const PACKAGE: &'static str = "xmtp.xmtpv4.message_api";
        fn full_name() -> ::prost::alloc::string::String {
            "xmtp.xmtpv4.message_api.SubscribeOriginatorsRequest.OriginatorFilter".into()
        }
        fn type_url() -> ::prost::alloc::string::String {
            "/xmtp.xmtpv4.message_api.SubscribeOriginatorsRequest.OriginatorFilter"
                .into()
        }
    }
}
impl ::prost::Name for SubscribeOriginatorsRequest {
    ...
    const PACKAGE: &'static str = "xmtp.xmtpv4.message_api";
    fn full_name() -> ::prost::alloc::string::String {
        "xmtp.xmtpv4.message_api.SubscribeOriginatorsRequest".into()
    }
    fn type_url() -> ::prost::alloc::string::String {
        "/xmtp.xmtpv4.message_api.SubscribeOriginatorsRequest".into()
    }
...
pub mod subscribe_originators_response {
    ...
    impl ::prost::Name for Envelopes {
        ...
        const PACKAGE: &'static str = "xmtp.xmtpv4.message_api";
        fn full_name() -> ::prost::alloc::string::String {
            "xmtp.xmtpv4.message_api.SubscribeOriginatorsResponse.Envelopes".into()
        }
        fn type_url() -> ::prost::alloc::string::String {
            "/xmtp.xmtpv4.message_api.SubscribeOriginatorsResponse.Envelopes".into()
        }
...
impl ::prost::Name for SubscribeOriginatorsResponse {
    ...
    const PACKAGE: &'static str = "xmtp.xmtpv4.message_api";
    fn full_name() -> ::prost::alloc::string::String {
        "xmtp.xmtpv4.message_api.SubscribeOriginatorsResponse".into()
    }
    fn type_url() -> ::prost::alloc::string::String {
        "/xmtp.xmtpv4.message_api.SubscribeOriginatorsResponse".into()
    }
...
pub mod replication_api_server {
    ...
    pub trait ReplicationApi: std::marker::Send + std::marker::Sync + 'static {
        /// Server streaming response type for the SubscribeOriginators method.
        type SubscribeOriginatorsStream: tonic::codegen::tokio_stream::Stream<
                Item = std::result::Result<
                    super::SubscribeOriginatorsResponse,
                    tonic::Status,
                >,
            >
            + std::marker::Send
        ...
        async fn subscribe_originators(
            &self,
            request: tonic::Request<super::SubscribeOriginatorsRequest>,
        ) -> std::result::Result<
            tonic::Response<Self::SubscribeOriginatorsStream>,
            tonic::Status,
        >;
        ...
        B::Error: Into<StdError> + std::marker::Send + 'static,
    {
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                "/xmtp.xmtpv4.message_api.ReplicationApi/SubscribeOriginators" => {
                    #[allow(non_camel_case_types)]
                    struct SubscribeOriginatorsSvc<T: ReplicationApi>(pub Arc<T>);
                    impl<
                        T: ReplicationApi,
                    > tonic::server::ServerStreamingService<
                        super::SubscribeOriginatorsRequest,
                    > for SubscribeOriginatorsSvc<T> {
                        type Response = super::SubscribeOriginatorsResponse;
                        type ResponseStream = T::SubscribeOriginatorsStream;
                        ...
                        fn call(
                            ...
                            let fut = async move {
                                <T as ReplicationApi>::subscribe_originators(
                                        &inner,
                                        request,
                                    )
                                    .await
                    ...
                    let fut = async move {
                        let method = SubscribeOriginatorsSvc(inner);
...
pub mod query_api_server {
    ...
    #[async_trait]
    pub trait QueryApi: std::marker::Send + std::marker::Sync + 'static {
        async fn query_envelopes(
            &self,
            request: tonic::Request<super::QueryEnvelopesRequest>,
        ) -> std::result::Result<
    ...
    impl<T, B> tonic::codegen::Service<http::Request<B>> for QueryApiServer<T>
    where
        T: QueryApi,
        B: Body + std::marker::Send + 'static,
        B::Error: Into<StdError> + std::marker::Send + 'static,
    {
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                "/xmtp.xmtpv4.message_api.QueryApi/QueryEnvelopes" => {
                    #[allow(non_camel_case_types)]
                    struct QueryEnvelopesSvc<T: QueryApi>(pub Arc<T>);
                    impl<
                        T: QueryApi,
                    > tonic::server::UnaryService<super::QueryEnvelopesRequest>
                    for QueryEnvelopesSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as QueryApi>::query_envelopes(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
                ...
                "/xmtp.xmtpv4.message_api.QueryApi/SubscribeTopics" => {
                    #[allow(non_camel_case_types)]
                    struct SubscribeTopicsSvc<T: QueryApi>(pub Arc<T>);
                    impl<
                        T: QueryApi,
                    > tonic::server::ServerStreamingService<
                        super::SubscribeTopicsRequest,
                    > for SubscribeTopicsSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as QueryApi>::subscribe_topics(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
                ...
                "/xmtp.xmtpv4.message_api.QueryApi/Subscribe" => {
                    #[allow(non_camel_case_types)]
                    struct SubscribeSvc<T: QueryApi>(pub Arc<T>);
                    impl<
                        T: QueryApi,
                    ...
                    for SubscribeSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as QueryApi>::subscribe(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
                ...
                "/xmtp.xmtpv4.message_api.QueryApi/GetInboxIds" => {
                    #[allow(non_camel_case_types)]
                    struct GetInboxIdsSvc<T: QueryApi>(pub Arc<T>);
                    impl<
                        T: QueryApi,
                    > tonic::server::UnaryService<super::GetInboxIdsRequest>
                    for GetInboxIdsSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as QueryApi>::get_inbox_ids(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
                ...
                "/xmtp.xmtpv4.message_api.QueryApi/GetNewestEnvelope" => {
                    #[allow(non_camel_case_types)]
                    struct GetNewestEnvelopeSvc<T: QueryApi>(pub Arc<T>);
                    impl<
                        T: QueryApi,
                    > tonic::server::UnaryService<super::GetNewestEnvelopeRequest>
                    for GetNewestEnvelopeSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as QueryApi>::get_newest_envelope(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
    ...
    impl<T> Clone for QueryApiServer<T> {
        fn clone(&self) -> Self {
            let inner = self.inner.clone();
            Self {
                inner,
    ...
    /// Generated gRPC service name
    pub const SERVICE_NAME: &str = "xmtp.xmtpv4.message_api.QueryApi";
    impl<T> tonic::server::NamedService for QueryApiServer<T> {
        const NAME: &'static str = SERVICE_NAME;
    }
}
#[derive(Clone, PartialEq, ::prost::Message)]
